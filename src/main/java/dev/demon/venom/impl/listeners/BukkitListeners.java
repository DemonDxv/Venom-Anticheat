...
public class BukkitListeners implements Listener {
    ...
    public void onProjectile(ProjectileLaunchEvent e) {
        if (e.getEntity().getShooter() instanceof Player) {
            ...
            User user = Venom.getInstance().getUserManager().getUser(shooter.getUniqueId());
            if (user != null) {
    ...
    public void onEntityDamage(EntityDamageByEntityEvent e) {
        ...
        if (e.getEntity() instanceof Player && e.getDamager() instanceof Player) {
            User user = Venom.getInstance().getUserManager().getUser(e.getDamager().getUniqueId());
            if (user != null) {
            ...
            User damageUser = Venom.getInstance().getUserManager().getUser(e.getEntity().getUniqueId());
            if (damageUser != null) {
