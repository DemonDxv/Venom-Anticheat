...
import dev.demon.venom.utils.box.simple.blocks.*;
import dev.demon.venom.utils.box.simple.types.*;
import dev.demon.venom.utils.math.MathUtil;
import dev.demon.venom.utils.reflection.ReflectionsUtil;
import lombok.val;
...
public enum BlockData {
    ...
    _RAIL((protocol, b) -> ReflectionsUtil.getBlockBoundingBox2(b).toCollisionBox(),Arrays.stream(Material.values())
