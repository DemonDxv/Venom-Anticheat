package dev.demon.venom.utils.command;
...
public class CommandUtils {
    ...
    public static void registerCommand(dev.demon.venom.impl.command.Command commandObject) {
        try {
    ...
    public static void unRegisterBukkitCommand(dev.demon.venom.impl.command.Command commandObject) {
        try {
